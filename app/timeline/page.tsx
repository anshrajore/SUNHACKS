...
const TIMELINE = [
  {
    ...
    events: [
      { time: "11:30 AM – 6:00 PM", icon: "🛬", title: "Check-In & Registration", description: "Check-in, verification and kit collection." },
      { time: "7:00 PM – 8:00 PM", icon: "🎤", title: "Opening Ceremony", description: "Welcome address and event overview." },
      { time: "8:00 PM – 9:00 PM", icon: "🚀", title: "Hackathon Officially Begins + Ideation Starts", description: "Problem statements released; teams begin ideation.", highlight: true },
      { time: "9:00 PM – 10:00 PM", icon: "🍽️", title: "Dinner Break", description: "Dinner break before the overnight sprint.", highlight: true },
      { time: "10:00 PM – 11:30 PM", icon: "🔥", title: "Campfire + Chill & Networking Session", description: "Relax, network and recharge." },
      { time: "11:30 PM onwards", icon: "💻", title: "All-Night Coding Begins", description: "Heads-down building through the night." },
    ],
  },
  {
    day: "Day 2 – 22nd August (Friday)",
    events: [
      { time: "2:00 AM – 3:00 AM", icon: "🧑‍🏫", title: "Mentors Round 1", description: "Early feedback and guidance." },
      { time: "3:00 AM – 6:00 AM", icon: "🌙", title: "Late-Night Code Sprint", description: "Deep work session." },
      { time: "7:00 AM – 8:00 AM", icon: "🥞", title: "Breakfast (on stalls)", description: "Morning breakfast." },
      { time: "8:00 AM – 10:00 AM", icon: "🧑‍⚖️", title: "Judging Round – 1 Presentations", description: "First round presentations.", highlight: true },
      { time: "10:00 AM – 11:00 AM", icon: "🧑‍🏫", title: "Mentor Round 2 – Implementation Feedback", description: "Implementation review and feedback." },
      { time: "12:00 PM – 1:00 PM", icon: "🍛", title: "Lunch", description: "Midday meal." },
      { time: "1:00 PM – 2:00 PM", icon: "⚡", title: "Code Sprint", description: "Focused sprint for improvements." },
      { time: "2:00 PM – 3:00 PM", icon: "🏅", title: "Awards for Asia Books of Records", description: "Special awards segment." },
      { time: "4:00 PM – 6:00 PM", icon: "🧑‍⚖️", title: "Judging Round – 2 Presentations", description: "Second round presentations." },
      { time: "6:00 PM – 6:30 PM", icon: "☕", title: "Refreshment Break", description: "Snacks and beverages." },
      { time: "6:30 PM – 7:00 PM", icon: "🤝", title: "Sponsorship Activity", description: "Partner showcase activity." },
      { time: "7:00 PM – 9:00 PM", icon: "🎶", title: "Cultural Night", description: "Music, performances and fun." },
      { time: "9:00 PM – 10:00 PM", icon: "🍽️", title: "Dinner Break", description: "Dinner break." },
      { time: "10:00 PM – 11:30 PM", icon: "🧪", title: "Mentors Round 3 – Testing", description: "Testing and final feedback." },
      { time: "11:30 PM – 12:30 AM", icon: "💻", title: "All-Night Coding Begins", description: "Final overnight build." },
    ],
  },
  {
    day: "Day 3 – 23rd August (Saturday)",
    events: [
      { time: "12:30 AM – 1:30 AM", icon: "🎵", title: "Jamming Session for students", description: "Unwind with a late-night jam." },
      { time: "1:30 AM – 6:00 AM", icon: "💻", title: "All-Night Coding Begins", description: "Wrap up the build." },
      { time: "6:00 AM – 8:00 AM", icon: "🥞", title: "Breakfast (on stalls)", description: "Breakfast to kickstart the day." },
      { time: "8:00 AM – 10:00 AM", icon: "🧑‍⚖️", title: "Judging Round – Demo Presentations", description: "Final demos to judges.", highlight: true },
      { time: "10:00 AM – 11:30 AM", icon: "👥", title: "Jury Deliberation + Group Photo", description: "Scoring and group photo." },
      { time: "11:30 AM – 12:30 AM", icon: "🏆", title: "Closing Ceremony & Winner Announcements", description: "Awards and closing notes.", highlight: true },
    ],
  },
];
